...
//                     scanf("%lf",&nbr2);
//                     resultat = multiply(nbr1,nbr2);
//                 }else{
//                     printf("Veuillez entrez le nombre suivant: ");
//                 scanf("%lf",&nbr1);
//                 resultat = multiply(resultat,nbr1);
//                 }
//                 }
...
//                     printf("deuxieme nombre 2: ");
//                     scanf("%lf",&nbr2);
//                    success = divide(nbr1,nbr2,&resultat);
//                     }else {
//                      printf("Veuillez entrez le nombre suivant: ");
//                 scanf("%lf",&nbr2);
//                 success = divide(resultat,nbr2,&resultat);   
//                     }
//                 while (!success)
//                     {
//                         int num;
...
//                         scanf("%lf",&nbr2);
//                         success=divide(num,nbr2,&resultat);
//                     }
